...
const InactivityModal: React.FC<InactivityModalProps> = ({
  ...
  const progressPercentage = (timeLeft / 20) * 100; // 20 secondes max
        ...
        <>
          ...
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
            <motion.div
              ...
              className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl w-full max-w-sm sm:max-w-md overflow-hidden border border-gray-200 dark:border-gray-800"
            >
              {/* Contenu */}
              <div className="p-6 sm:p-8">
                ...
                <div className="mb-6 sm:mb-8">
                  <div className="text-center mb-4">
                    <div className="inline-flex items-baseline gap-1">
                      <span className="text-4xl sm:text-5xl font-light text-gray-900 dark:text-white tabular-nums">
                ...
                <motion.button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-6 py-3.5 sm:py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-medium transition-colors shadow-sm text-base sm:text-lg"
                >
